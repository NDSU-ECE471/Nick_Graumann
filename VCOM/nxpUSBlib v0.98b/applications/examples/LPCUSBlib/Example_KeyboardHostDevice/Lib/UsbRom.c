...
{
	return VirtualSerial_CDC_Interface.Config.DataINEndpointNumber;
}
uint32_t CALLBACK_UsbdCdc_Register_ControlInterfaceDescriptor(void)
{
	return (uint32_t)&(ConfigurationDescriptor.CDC_CCI_Interface);
}
uint32_t CALLBACK_UsbdCdc_Register_DataInterfaceDescriptor(void)
{
	return (uint32_t)&(ConfigurationDescriptor.CDC_DCI_Interface);
}
uint32_t CALLBACK_UsbdCdc_Register_LineCoding(void)
{
	return (uint32_t)&(VirtualSerial_CDC_Interface.State.LineEncoding);
}
...
{
	return VirtualSerial_CDC_Interface.Config.DataOUTEndpointNumber;
}
uint8_t CALLBACK_UsbdCdc_Register_NotificationEndpointNumber(void)
{
	return VirtualSerial_CDC_Interface.Config.NotificationEndpointNumber;
}

uint32_t CALLBACK_UsbdCdc_Register_DataOutEndpointSize(void)
{
	return VirtualSerial_CDC_Interface.Config.DataOUTEndpointSize;
}
uint32_t CALLBACK_UsbdCdc_Register_DataInEndpointSize(void)
{
	return VirtualSerial_CDC_Interface.Config.DataINEndpointSize;
}
