=================================
==                             ==
== DeviceBandwidthTest project ==
==                             ==
=================================
This project work in conjunction with a PC side application to show the load
of the CPU while sending or receiving bulk transfers over the USB bus. The
loads that are displayed include foreground USB activity, the USB IRQ, and
the remaining CPU.
...
This project can be built and debugged using two compiler tool chains.
...
The software that makes up this project is designed to run on many different
...
Configure projects:
  ...
  repeat these steps with the CDL, LPCUSBlib, and Project_DeviceBandwidthTest

Configure MCU:
  right click on the Project_DeviceBandwidthTest project in the project explorer window
...
Configure the indexer:
   click Window->Preferences->C/C++->Indexer->Use active build configuration
                                     ...
                                     BSP                 CDL           LPCUSBlib     Project_DeviceBandwidthTest   MCU
                           ======================= ===============  ==============  =========================  ========
...
Configure a Batch Build:
  ...
  repeat these steps with the CDL, LPCUSBlib_Device, and Project_DeviceBandwidthTest

                             BSP                      CDL     LPCUSBlib_Device  DeviceBandwidthTest 
                          ==========               =========  ================  =================
...
Run the included PC app LPCUsbTest.exe to drive the bandwidth test from the host
...
In the project explorer window of the IDE right click on the
  Project_DeviceBandwidthTest project and select Debug As->C/C++ MCU Application
