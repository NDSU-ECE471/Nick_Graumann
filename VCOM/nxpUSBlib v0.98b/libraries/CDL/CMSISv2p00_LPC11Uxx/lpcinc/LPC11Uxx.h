...
FLEX_INT0_IRQn                = 0,        /*!< All I/O pins can be routed to below 8 interrupts. */
  ...
  CT16B0_IRQn                   = 16,       /*!< 16-bit Timer0 Interrupt                          */
  CT16B1_IRQn                   = 17,       /*!< 16-bit Timer1 Interrupt                          */
  CT32B0_IRQn                   = 18,       /*!< 32-bit Timer0 Interrupt                          */
  CT32B1_IRQn                   = 19,       /*!< 32-bit Timer1 Interrupt                          */
